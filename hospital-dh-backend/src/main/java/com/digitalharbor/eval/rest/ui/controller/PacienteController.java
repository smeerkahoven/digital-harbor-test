...
public class PacienteController {
	 ...
	 */
	@PostMapping
	public PacienteResponse create( @RequestHeader(name ="publicId",required =true) String publicId ,
	...
	@GetMapping("{id}")
	public PacienteResponse get(@PathVariable(value = "id") Integer id) {
		PacienteResponse response = new PacienteResponse();
	...
	@GetMapping
	public PacienteResponse getAll() {
		PacienteResponse response = new PacienteResponse();

		try {

			List<PacienteDto> list = service.get();
